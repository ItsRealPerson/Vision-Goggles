...
public class VisionCurioRenderer implements ICurioRenderer {
    private ExoHelmetModel<LivingEntity> model;
    
    private static final ResourceLocation NVG_TEXTURE = new ResourceLocation(VisionGoggles.MODID, "textures/entities/nvg_texture.png");
    private static final ResourceLocation NVG_GLOW = new ResourceLocation(VisionGoggles.MODID, "textures/entities/nvg_glow.png");
    
    private static final ResourceLocation THERMAL_TEXTURE = new ResourceLocation(VisionGoggles.MODID, "textures/entities/thermal_vision.png");
    private static final ResourceLocation THERMAL_GLOW = new ResourceLocation(VisionGoggles.MODID, "textures/entities/thermal_glow.png");
    ...
    public <T extends LivingEntity, M extends EntityModel<T>> void render(ItemStack stack, SlotContext slotContext, PoseStack matrixStack, RenderLayerParent<T, M> renderLayerParent, MultiBufferSource renderTypeBuffer, int light, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (stack.getItem() == VisionGoggles.THERMAL_GOGGLES_HELMET.get()) {
